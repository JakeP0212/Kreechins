...
class Game {
    ...
    public static void main(String[] args) {
        ...
        Kreechin b = new Kreechin(kreechins.get(1), 10, true, new int[]{1, 3, 0, 0, 0}, 1);
        Kreechin c = new Kreechin(kreechins.get(2), 10, true, new int[]{1, 4, 0, 0, 0}, 4);
        Kreechin d = new Kreechin(kreechins.get(1), 10, false, new int[]{1, 3, 0, 0, 0}, 3);
