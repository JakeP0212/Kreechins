...
public class MoveSetup {
    ...
    public static ArrayList<Move> setup() {
        ...
        moves.add(new Move("Slam", 1, "1 Opponent", 5, 90, 0, new int[]{1}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Soak", 20);
        moves.add(new Move("Whirlpool", 2, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        //0035
        effects.put("Target - Burn", 20);
        moves.add(new Move("Flamethrower", 3, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Lower Focus", 40);
        moves.add(new Move("Overgrowth", 4, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Shock", 20);
        moves.add(new Move("Thunderbolt", 5, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Freeze", 15);
        moves.add(new Move("Snowball Smash", 6, "1 Opponent", 5, 90, 0, new int[]{4}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Lower Speed", 40);
        moves.add(new Move("Sky Strike", 7, "1 Opponent", 5, 90, 0, new int[]{1}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        //0040
        effects.put("Target - Lower Energy", 40);
        moves.add(new Move("Landslide", 8, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Lower Defense", 40);
        moves.add(new Move("Iron Punch", 9, "1 Opponent", 5, 90, 0, new int[]{1, 5}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Lower HP", 40);
        moves.add(new Move("Life Drain", 10, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Wound", 20);
        moves.add(new Move("Tactical Assault", 11, "1 Opponent", 5, 90, 0, new int[]{1}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Attract", 20);
        moves.add(new Move("Heart Beam", 12, "1 Opponent", 5, 90, 0, new int[]{7}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        //0045
        effects.put("Target - Confuse", 20);
        moves.add(new Move("Crazy Cannon", 13, "1 Opponent", 5, 90, 0, new int[]{0}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Suffocate", 20);
        moves.add(new Move("Spacevoid Slam", 14, "1 Opponent", 5, 90, 0, new int[]{1}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Enchant", 20);
        moves.add(new Move("Enchanting Pulse", 15, "1 Opponent", 5, 90, 0, new int[]{7}, copyMap(effects), 85, 1, 1));
        effects.clear();
        
        effects.put("Target - Lower Luck", 40);
        moves.add(new Move("Colorful Clash", 16, "1 Opponent", 5, 90, 0, new int[]{1}, copyMap(effects), 85, 1, 1));
        effects.clear();
    ...
    public static HashMap<String, Integer> copyMap(HashMap<String, Integer> map) {
        HashMap<String, Integer> deepCopy = new HashMap<String, Integer>();
