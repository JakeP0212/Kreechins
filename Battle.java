public class Battle {
    ...
    public static double findEffectiveness(int moveType, int cat1) {
        return typeChart[moveType - 1][cat1 - 1];
    }

    public static double findEffectiveness(int moveType, int cat1, int cat2) {
        return (typeChart[moveType - 1][cat1 - 1] * typeChart[moveType - 1][cat2 - 1]);
    }
